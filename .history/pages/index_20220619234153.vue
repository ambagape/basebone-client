<template>
  <div>
    <v-row>
      <v-col md="4">
        <UserCard class="mb-5" :_id="item._id" :email="item.title" :msisdn="item.msisdn" :oauth_user_id="item.oauth_user_id"  :user_type="item.user_type" :free_premium_items="item.free_premium_items">
...
<script>
import UserCard from "@/components/BookCard";
import UserModal from "@/components/BookModal";
